package com.drally.toolkit.tkauth.config;

import com.drally.toolkit.tkauth.service.AppClientDetailService;
...
//	}
	...
	public void configure(AuthorizationServerEndpointsConfigurer endpoints) throws Exception {
		endpoints
			    ...
			    .userDetailsService(appClientDetailService)
	...
	protected void configure(AuthenticationManagerBuilder auth) throws Exception {
		auth.userDetailsService(appClientDetailService).passwordEncoder(passwordEncoder());
	}
