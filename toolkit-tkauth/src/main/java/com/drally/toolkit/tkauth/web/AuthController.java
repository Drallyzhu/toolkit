package com.drally.toolkit.tkauth.web;

import com.drally.toolkit.domain.auth.model.AuthLoginRequest;
import com.drally.toolkit.domain.auth.model.AuthRegRequest;
import com.drally.toolkit.domain.auth.model.AuthUser;
import com.drally.toolkit.tkauth.client.UserClient;
import com.drally.toolkit.tkauth.constant.ConstantKey;
import com.drally.toolkit.common.util.RedisUtil;
import com.drally.toolkit.common.util.ResponseBo;
import com.drally.toolkit.common.util.SmsUtils;
...
public class AuthController {
    ...
    public ResponseBo<Boolean> vcode(@RequestParam String mobile){
        ...
        String vcode = SmsUtils.createCode(6);
        if (SmsUtils.sendVcode("【全币支付】", mobile, vcode)){
