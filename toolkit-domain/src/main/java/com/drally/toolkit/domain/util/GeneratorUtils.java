package com.drally.toolkit.domain.util;
...
public class GeneratorUtils implements Serializable {
    ...
    private PackageConfig packageConfig(){
        ...
        packageConfig.setParent("com.sofyun.user");
    ...
    public static void main(String[] args) {
        String dataUrl = DATA_PATH
                ...
                .replace("PORT", "3306")
                .replace("DATABASE", "star_user");
        GeneratorUtils generatorUtils = new GeneratorBuilder()
                .outputDir("E:/OpenSource/star/star-user/src/main/java")
                .author("gm")
                .dataUrl(dataUrl)
